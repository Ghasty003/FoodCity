...
function Card({price, title, description, img, id}: CardProps) {
    ...
    return (
        <div className='bg-cardOverlay backdrop-blur-lg hover:drop-shadow-lg h-40 w-[280px] rounded-xl relative p-4 mx-5'>
            ...
            <div className='flex flex-col items-end justify-end'>
                <span onClick={() => addItemToCart(title, description, price, img, id)} className='bg-red-600 p-2 mt-2 rounded-full text-center cursor-pointer'>
